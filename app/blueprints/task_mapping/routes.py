...
from .upload_helpers import _safe_uploaded_filename
...
def _localize_mapping_message(message: str) -> str:
    ...
    replacements = [
        ...
        ("Add Image", "插入圖片"),
        ("Append heading", "插入標題"),
        ("Numbered Heading", "插入阿拉伯數字標題"),
        ("Roman Heading", "插入羅馬數字標題"),
        ("Bulleted Heading", "插入項目符號標題"),
        ...
        ("template_merge", "模版合併"),
        ("insert_text", "插入純文字段落"),
        ("insert_numbered_heading", "插入阿拉伯數字標題"),
        ("insert_roman_heading", "插入羅馬數字標題"),
        ("insert_bulleted_heading", "插入項目符號標題"),
        # ("title=", "標題="),
        # ("index=", "編號="),
        # ("pages=", "頁碼="),
    ]
