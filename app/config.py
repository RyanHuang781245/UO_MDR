...
class BaseConfig:
    ...
    APP_LOG_MAX_MB = int(os.environ.get("APP_LOG_MAX_MB") or 10)
    ...
    REGULATION_EU_2017_745_REFERENCE_FALLBACK_FOLDER_CONFIGURED = (
        os.environ.get("REGULATION_EU_2017_745_REFERENCE_FALLBACK_FOLDER") or ""
    ).strip()
    REGULATION_EU_2017_745_REFERENCE_FOLDER = str(BASE_DIR / "harmonised_store")
    REGULATION_EU_2017_745_REFERENCE_FALLBACK_FOLDER = (
        REGULATION_EU_2017_745_REFERENCE_FALLBACK_FOLDER_CONFIGURED or str(BASE_DIR / "harmonised_store")
    )
