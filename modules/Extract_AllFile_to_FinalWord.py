        ...
        for i in range(node.ChildObjects.Count):
            ...
            if isinstance(child, Paragraph):
                if "toc" in child.StyleName.lower() or "目錄" in child.StyleName.lower():
                    continue
                list_type = child.ListFormat.ListType
                list_level = child.ListFormat.ListLevelNumber
                paragraph_text = ""
                ...
                if list_type == ListType.Bulleted:
                    para.ListFormat.ApplyBulletStyle()
                    para.ListFormat.ListLevelNumber = list_level
